...
class CourseUrlTest(unittest.TestCase):
    ...
    sample_url1 = "https://api.betatest.degreed.com/api/v2/content/?filter[term]=Proofing,Software Development"
    sample_url2 = "https://api.betatest.degreed.com/api/v2/content/?filter[wrong_term]=Proofing,Software Development"
    ...
    @parameterized.expand(
        [
            ...
            [
                sample_url2,
                "https://api.betatest.degreed.com/api/v2/content/?filter%5Bwrong_term%5D=Proofing%2CSoftware+Development",
            ],
        ]
    )
