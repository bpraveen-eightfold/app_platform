...
Stripped of the legacy gflags dependency so it works on Python 3.12+.
The public API (info, warn, error, debug, fatal, check_*, setLevel, …)
is unchanged.
"""
...
def init(level=logging.INFO):
    """Initialise the root logger at the given level."""
    setLevel(level)
