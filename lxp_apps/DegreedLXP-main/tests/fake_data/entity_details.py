    ...
    data = {
        "data": {
            ...
            "attributes": {
                ...
                "summary": "Learn how to give an impressive speech in the Public Speaking - "
                "Communicating with Confidence course, delivered by award "
                "winning presenter TJ Walker.",
            ...
            "links": {
                "self": "https://api.betatest.degreed.com/api/v2/content/rwoA7p5"
            },
        }
    }
    return data
