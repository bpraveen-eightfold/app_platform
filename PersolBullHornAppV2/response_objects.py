...
class  AssessmentTestSchema(EFBaseResponse):
    ...
    def __init__(self, test_id=None, name=None, duration_minutes=None, published=None):
        super( AssessmentTestSchema, self).__init__()
...
class ApplicationAssessmentData(EFBaseResponse):
    ...
    def __init__(self):
        super(ApplicationAssessmentData, self).__init__()
...
class AssessmentPostInstallResponseType(EFBaseResponse):
    def __init__(self):
