...
class AssessmentTest(EFBaseResponse):
    ...
    def __init__(self, test_id=None, name=None, duration_minutes=None, published=None):
        super(AssessmentTest, self).__init__()
...
class AssessmentInviteCandidateResponseType(EFBaseResponse):
    ...
    def __init__(self, email, vendor_candidate_id=None, test_url=None, invite_already_sent=None,
                 assessment_id=None):
        super(AssessmentInviteCandidateResponseType, self).__init__()
        self.email = email
...
class AssessmentReportResponse(EFBaseResponse):
    """ This represents the assessment data for an application """
    def __init__(self):
        super(AssessmentReportResponse, self).__init__()
...
class AssessmentTestStatus(object):
...
class AssessmentProcessWebhookResponseType(EFBaseResponse):
    def __init__(self):
        super(AssessmentProcessWebhookResponseType, self).__init__()
        self.invite_metadata = None
        self.assessment_report = None

class AssessmentGetLogoUrlResponseType(EFBaseResponse):
    def __init__(self):
        super(AssessmentGetLogoUrlResponseType, self).__init__()
        self.logo_url = None

class AssessmentIsWebhookSupportedResponseType(EFBaseResponse):
    def __init__(self):
        super(AssessmentIsWebhookSupportedResponseType, self).__init__()
        self.is_webhook_supported = None

class PostInstallResponseType(EFBaseResponse):
    def __init__(self):
        super(EFBaseResponse, self).__init__()
